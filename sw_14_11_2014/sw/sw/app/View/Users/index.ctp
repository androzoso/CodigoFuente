<div class="users index">
	...
	<tr>
		...
		<td><?php echo h($user['User']['documento']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['nombre']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['apellido']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['fecha']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['correo']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['pais']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['institucion']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['usuario']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['contraseña']); ?>&nbsp;</td>
		<td class="actions">
